...
<div class="kt-pagebody">
  ...
  <form id="post-form" enctype="multipart/form-data" action="{{ route('post.update', [ 'id' => $post->id, 'post' => $post ]) }}" method="POST">
    @csrf 
    @method('PUT')
    @if(isset($success))
        ...
        <div class="row mg-b-25">
          <div class="col-12">
            <div class="form-group mg-b-10-force">
              ...
              <input class="form-control" value="{{ $post->title }}" data-placeholder="Title" aria-hidden="true" id="title" name="title" required
                type="text" />
            </div>
          </div>
        </div>
    ...
    <div id="editor_box">
      <div class="col-lg-12 form-layout">
        <div class="form-group mg-b-10-force">
          ...
          <div id="editor" style="height: 300px; border: 1px solid rgba(68, 68, 68, 0.26);">{!! $post->body !!}</div>
          <textarea rows="3" class="hidden form-control select2 select2-hidden-accessible" name="body" id="body"
            ...
            placeholder="This is the initial editor content.">{!! $post->body !!}</textarea>
        </div>
      </div>
      ...
      <div class="form-layout">
        <div class="row mg-b-25">
          ...
          <div class="col-lg-6">
            ...
            <input type="datetime-local" value="{{ $post->publish_date }}" class="form-control" placeholder="MM/DD/YYYY" id="publish_date"
                name="publish_date" />
            </div>
          </div>
          <!-- col-4 -->
